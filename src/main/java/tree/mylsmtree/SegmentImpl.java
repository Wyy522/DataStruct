...
public class SegmentImpl implements Segment {
    private final String SEGMENT_FILE_NAME = "seg_";
    ...
    public SegmentImpl(String path, int segmentId, int levelNumb, int partSize) {
        this.path = path;
    ...
    public void persist(TreeMap<String, Command> memTable) throws IOException {
        String fileName = FileUtils.buildFileName(path, String.valueOf(levelNumb), String.valueOf(segmentId), SEGMENT_FILE_NAME);
